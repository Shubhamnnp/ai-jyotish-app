...
class IshtaDevataEngine:
    ...
    def _compute_navratri_guidelines(
        ...
        # 4. Day-by-Day (1 to 9 Days) Astrological Scan for the Native
        # Check planetary status for personalized advice
        sun_p = chart.planets.get("Sun")
        moon_p = chart.planets.get("Moon")
        mars_p = chart.planets.get("Mars")
        merc_p = chart.planets.get("Mercury")
        jup_p = chart.planets.get("Jupiter")
        ven_p = chart.planets.get("Venus")
        sat_p = chart.planets.get("Saturn")
        rahu_p = chart.planets.get("Rahu")
        ketu_p = chart.planets.get("Ketu")

        def _is_priority(p_name: str) -> bool:
            if p_name == ak_planet or p_name == lagna_lord or p_name == ishta_planet:
                return True
            p = chart.planets.get(p_name)
            if p and (p.dignity in ("debilitated", "enemy") or p.house_from_lagna in (6, 8, 12)):
                return True
            return False
        ...
        nine_days = [
            {
                "day_num": 1,
                "tithi": "प्रतिपदा (प्रथम दिवस)",
                "deity": "माँ शैलपुत्री",
                "graha": "सूर्य (Sun)",
                "chakra": "मूलाधार चक्र (स्थिरता व सुरक्षा)",
                "chakra_color": "#EF4444",
                "is_priority": _is_priority("Sun"),
                "kundali_context": f"आपकी कुण्डली में सूर्य {sun_p.house_from_lagna if sun_p else 1}वें भाव ({sun_p.sign_name if sun_p else 'मेष'}) में स्थित हैं। इस दिन शैलपुत्री पूजन से आत्मबल, तेज व पिता-प्रशासन से लाभ मिलता है।",
                "vrat_type": "घटस्थापना संकल्प, अखण्ड दीप प्रज्वलन एवं सात्विक जलाहार/फलाहार व्रत",
                "bhog": "गाय का शुद्ध देशी घी, लाल फल (अनार, सेब)",
                "mantra": "ॐ ऐं ह्रीं क्लीं शैलपुत्र्यै नमः || वन्दे वाञ्छितलाभाय चन्द्रार्धकृतशेखराम्। वृषारूढां शूलधरां शैलपुत्रीं यशस्विनीम्॥",
                "vidhan": "प्रातः काल ईशान कोण में वेदी बनाकर जौ (ज्वारे) बोएं, तांबे/मिट्टी का कलश स्थापित करें और अखण्ड ज्योति प्रज्वलित करें।"
            },
            {
                "day_num": 2,
                "tithi": "द्वितीया (द्वितीय दिवस)",
                "deity": "माँ ब्रह्मचारिणी",
                "graha": "चन्द्र (Moon)",
                "chakra": "स्वाधिष्ठान चक्र (संयम व भावना शुद्धि)",
                "chakra_color": "#F97316",
                "is_priority": _is_priority("Moon"),
                "kundali_context": f"आपकी कुण्डली में चन्द्र {moon_p.house_from_lagna if moon_p else 1}वें भाव ({moon_p.sign_name if moon_p else 'वृषभ'}) में हैं। ब्रह्मचारिणी उपासना से मानसिक अशांति, अनिद्रा व तनाव नष्ट होकर संयम बढ़ता है।",
                "vrat_type": "पयोव्रत (दुग्धाहार) अथवा निर्जल/सजल ध्यान व्रत",
                "bhog": "शर्करा (मिश्री), दूध की खीर, सफेद पेड़ा",
                "mantra": "ॐ ऐं ह्रीं क्लीं ब्रह्मचारिण्यै नमः || दधाना करपद्माभ्यामक्षमालाकमण्डलू। देवी प्रसीदतु मयि ब्रह्मचारिण्यनुत्तमा॥",
                "vidhan": "चांदी अथवा सफेद आसन पर बैठकर चंद्र बीज मंत्र व माता ब्रह्मचारिणी की स्तुति करें। मन को शांत रखने हेतु मौन साधना रखें।"
            },
            {
                "day_num": 3,
                "tithi": "तृतीया (तृतीय दिवस)",
                "deity": "माँ चन्द्रघण्टा",
                "graha": "शुक्र (Venus)",
                "chakra": "मणिपुर चक्र (साहस, तेज व ऊर्जा)",
                "chakra_color": "#EAB308",
                "is_priority": _is_priority("Venus"),
                "kundali_context": f"आपकी कुण्डली में शुक्र {ven_p.house_from_lagna if ven_p else 1}वें भाव ({ven_p.sign_name if ven_p else 'तुला'}) में हैं। माँ चंद्रघंटा की कृपा से समस्त भयों का नाश, आकर्षण, ऐश्वर्य व सौहार्द प्राप्त होता है।",
                "vrat_type": "फलाहार (दूध, फल) अथवा सायंकाल नक्तव्रत",
                "bhog": "दूध की मिठाइयां, रबड़ी, मखाने की खीर",
                "mantra": "ॐ ऐं ह्रीं क्लीं चन्द्रघण्टायै नमः || पिण्डजप्रवरारूढा चण्डकोपास्त्रकैर्युता। प्रसादमस्त्वं जयति चन्द्रघण्टेति विश्रुता॥",
                "vidhan": "घंटे या घड़ियाल की ध्वनि से आरती करें। सुगंधित धूप (चंदन/गुलाब) अर्पित करें। स्वर्ण या पीले वस्त्र पहनना उत्तम है।"
            },
            {
                "day_num": 4,
                "tithi": "चतुर्थी (चतुर्थ दिवस)",
                "deity": "माँ कूष्माण्डा",
                "graha": "सूर्य (Surya - सृष्टि उद्भव स्वरूप)",
                "chakra": "अनाहत चक्र (आरोग्य व दिव्य प्रेम)",
                "chakra_color": "#10B981",
                "is_priority": _is_priority("Sun"),
                "kundali_context": "माँ कूष्मांडा सूर्यमंडल के भीतर निवास करती हैं। इनके पूजन से पुरानी बीमारियों, नेत्र पीड़ा व रक्त विकार से मुक्ति तथा जीवनी शक्ति प्राप्त होती है।",
                "vrat_type": "जलाहार (नारियल पानी, नींबू-मिश्री जल) एवं फलाहार",
                "bhog": "मालपुआ, पेठा (कुष्मांड फल), हरी इलायची",
                "mantra": "ॐ ऐं ह्रीं क्लीं कूष्माण्डायै नमः || सुरासम्पूर्णकलशं रुधिराप्लुतमेव च। दधाना हस्तपद्माभ्यां कूष्माण्डा शुभदास्तु मे॥",
                "vidhan": "सूर्य की दिशा (पूर्व) की ओर मुख करके कुष्मांड (पेठा) अथवा मालपुए का भोग लगाएं और आरोग्य की प्रार्थना करें।"
            },
            {
                "day_num": 5,
                "tithi": "पंचमी (पंचम दिवस)",
                "deity": "माँ स्कन्दमाता",
                "graha": "बुध (Mercury) एवं मंगल (Mars)",
                "chakra": "विशुद्ध चक्र (ज्ञान, वाणी व मेधा)",
                "chakra_color": "#06B6D4",
                "is_priority": _is_priority("Mercury") or _is_priority("Mars"),
                "kundali_context": f"आपकी कुण्डली में बुध {merc_p.house_from_lagna if merc_p else 1}वें व मंगल {mars_p.house_from_lagna if mars_p else 1}वें भाव में हैं। स्कंदमाता संतान सुख, बुद्धि-विवेक एवं व्यापार में अभूतपूर्व उन्नति देती हैं।",
                "vrat_type": "ऋतु फल आधारित फलाहार व्रत",
                "bhog": "पके पीले केले, बेसन के लड्डू, पंचमेवा",
                "mantra": "ॐ ह्रीं क्लीं स्कन्दमात्रे नमः || सिंहासनगता नित्यं पद्माश्रितकरद्वया। शुभदास्तु सदा देवी स्कन्दमाता यशस्विनी॥",
                "vidhan": "गोद में बालक रूपी भगवान कार्तिकेय को धारण करने वाली माँ को पीले पुष्प व केले अर्पित करें। संतान रक्षा का संकल्प लें।"
            },
            {
                "day_num": 6,
                "tithi": "षष्ठी (षष्ठ दिवस)",
                "deity": "माँ कात्यायनी",
                "graha": "बृहस्पति (Jupiter)",
                "chakra": "आज्ञा चक्र (प्रज्ञा, विवेक व सिद्धि)",
                "chakra_color": "#6366F1",
                "is_priority": _is_priority("Jupiter"),
                "kundali_context": f"आपकी कुण्डली में गुरु {jup_p.house_from_lagna if jup_p else 1}वें भाव ({jup_p.sign_name if jup_p else 'धनु'}) में हैं। कात्यायनी पूजन से शीघ्र अनुकूल विवाह, वैवाहिक कलह शांति एवं उच्च पद-प्रतिष्ठा मिलती है।",
                "vrat_type": "मधु (शहद) युक्त फलाहार अथवा एकभुक्त व्रत",
                "bhog": "शुद्ध मधु (शहद), केसर भात, मीठी पूरी",
                "mantra": "ॐ ह्रीं श्रीं कात्यायन्यै स्वाहा || कात्यायनि महामाये महायोगिन्यधीश्वरि। नन्दगोपसुतं देवि पतिं मे कुरु ते नमः॥",
                "vidhan": "सायंकाल गोधूलि वेला में पूजा विशेष फलदायी है। माता को शहद अर्पित करें और सुहाग सामग्री अथवा विवाह संकल्प करें।"
            },
            {
                "day_num": 7,
                "tithi": "सप्तमी (सप्तम दिवस)",
                "deity": "माँ कालरात्रि",
                "graha": "शनि (Saturn) एवं राहु (Rahu)",
                "chakra": "सहस्रार चक्र (भय-मुक्ति व पूर्ण सुरक्षा)",
                "chakra_color": "#8B5CF6",
                "is_priority": _is_priority("Saturn") or _is_priority("Rahu"),
                "kundali_context": f"आपकी कुण्डली में शनि {sat_p.house_from_lagna if sat_p else 1}वें भाव में हैं। कालरात्रि पूजन से कालभय, साढ़ेसाती/ढैया, शत्रु-षड्यंत्र व तंत्र-बाधा का समूल नाश होता है।",
                "vrat_type": "त्रिरत्रि व्रत आरंभ — कठोर जलाहार अथवा फलाहार व्रत",
                "bhog": "गुड़ का नैवेद्य, हलवा-पूरी, काले तिल",
                "mantra": "ॐ ऐं ह्रीं क्लीं कालरात्र्यै नमः || एकवेणी जपाकर्णपूरा नग्ना खरास्थिता। लम्बोष्ठी कर्णिकाकर्णी तैलाभ्यक्तशरीरिणी॥",
                "vidhan": "मध्यरात्रि (निशीथ काल) में जप व आरती अति प्रभावशाली है। सरसों/तिल के तेल का चौमुखा दीपक जलाएं।"
            },
            {
                "day_num": 8,
                "tithi": "अष्टमी (महाअष्टमी दिवस)",
                "deity": "माँ महागौरी",
                "graha": "राहु (Rahu) एवं चन्द्र (Moon)",
                "chakra": "सोम चक्र (परम शांति, सौभाग्य व पापनाश)",
                "chakra_color": "#EC4899",
                "is_priority": True, # Always pivotal
                "kundali_context": "महाअष्टमी संपूर्ण नवरात्रि का मेरुदंड है। इस दिन महागौरी की कृपा से जन्म-जन्मांतर के पाप कटते हैं और अखंड सौभाग्य व धन-समृद्धि मिलती है।",
                "vrat_type": "महाअष्टमी पूर्ण उपवास (कुण्डली अनुसार निर्जला या फलाहार)",
                "bhog": "नारियल, हलवा, पूरी, काले चने, खीर",
                "mantra": "ॐ श्रीं क्लीं महागौर्ये नमः || श्वेते वृषे समारूढा श्वेताम्बरधरा शुचिः। महागौरी शुभं दद्यान्महादेवप्रमोददा॥",
                "vidhan": "अष्टमी व नवमी के संधिकाल में 'संधि पूजा' करें (१०८ दीपक प्रज्वलन)। कन्याओं का पूजन करें। श्वेत वस्त्र धारण करें।"
            },
            {
                "day_num": 9,
                "tithi": "नवमी (महानवमी दिवस)",
                "deity": "माँ सिद्धिदात्री",
                "graha": "केतु (Ketu) एवं गुरु (Jupiter)",
                "chakra": "निर्वाण चक्र (अष्टसिद्धि एवं कैवल्य मोक्ष)",
                "chakra_color": "#F43F5E",
                "is_priority": True, # Always pivotal
                "kundali_context": f"आपकी कुण्डली में केतु {ketu_p.house_from_lagna if ketu_p else 1}वें भाव में हैं। सिद्धिदात्री समस्त अष्टसिद्धियों, मोक्ष व धर्म-अर्थ-काम की प्रदायिनी हैं।",
                "vrat_type": "महानवमी व्रत, नवचंडी हवन व कन्या पूजन विधान",
                "bhog": "काले तिल, खीर, पूड़ी, हलवा, पंचामृत",
                "mantra": "ॐ ह्रीं क्लीं सिद्धिदात्र्यै नमः || सिद्धगन्धर्वयक्षाद्यैरसुरैरमरैरपि। सेव्यमाना सदा भूयात् सिद्धिदा सिद्धिदायिनी॥",
                "vidhan": "प्रातः दुर्गा सप्तशती का पाठ व नवचंडी हवन करें। ९ कन्याओं व १ लंगूर (बटुक भैरव) का पाद प्रक्षालन कर भोजन कराएं, दक्षिणा दें और पारण करें।"
            }
        ]
